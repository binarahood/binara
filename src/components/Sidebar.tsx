...
export default function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return <aside className={`hidden md:flex fixed left-0 top-0 h-full z-40 flex-col bg-card border-r border-border transition-all duration-300 ease-in-out ${collapsed ? 'w-16' : 'w-60'}`}>
